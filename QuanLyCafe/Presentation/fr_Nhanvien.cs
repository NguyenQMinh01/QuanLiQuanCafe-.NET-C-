...
namespace QuanLyCafe.Presentation
{
    public partial class fr_Nhanvien : Form
    {
        ...
        public void khoitaoluoi()
        {
            ...
            msds.Columns[5].HeaderText = "Quê Quán";
        ...
        public void hienthi()
        {
            string sql = "SELECT manv,tennv,diachi,gioitinh,ngaysinh,tenque,sdt FROM tb_Nhanvien";
        ...
        private void msds_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                txtTenQue.Text = msds.Rows[dong].Cells[5].Value.ToString();
        ...
        private void txtTenQue_SelectedIndexChanged(object sender, EventArgs e)
        {
            lbtenque.Text = thucthi.loadtenq(lbtenque.Text, txtTenQue.Text);
        }
    }
}
